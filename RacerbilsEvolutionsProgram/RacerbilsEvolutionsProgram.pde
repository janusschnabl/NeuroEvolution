...
void draw() {
  ...
  text("Generation #: " + carSystem.getGenerations(), 860, 16);
  text("Cycles left: " + (lifetime-lifecycle), 860, 32);
  text("Record cycles: " + lifetime, 860, 48);
  text("Population size: " + carSystem.population.size(), 860, 64);
  text("Succesful laps: " +succes ,860, 80);
